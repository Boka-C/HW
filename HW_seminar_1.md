...
```
В случае если в ветке есть несохраненные и не влитые в ветку master изменения, гит сообщит об этом. Мы можем посмотреть разницу, внести изминения сохранить и закоммитить их командой > git commit -am "", влить все изминения в ветку мастер и только после разришения всех конфликтов безприпятственно удалить ненужную ветвь.
